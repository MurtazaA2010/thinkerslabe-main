            ...
            <article className="max-w-4xl mx-auto px-6 py-12">
                ...
                <div className="mb-10 text-center">
                    <div className="flex items-center justify-center space-x-3 text-sm font-bold uppercase tracking-widest mb-6">
                        ...
                        <span className="text-gray-600 dark:text-gray-400">{blog.date}</span>
                    </div>
                    <h1 className="text-4xl md:text-6xl font-bold mb-8 tracking-tight text-gray-900 dark:text-white leading-tight">
                        {blog.title}
                    </h1>
                    <div className="flex items-center justify-center">
                        ...
                        <span className="text-lg text-gray-700 dark:text-gray-300 font-medium">{blog.author}</span>
                    </div>
                </div>
                ...
                {/* Content */}
                <div
                    className="glass-card rounded-3xl p-8 md:p-12 text-gray-700 dark:text-gray-300 text-lg leading-relaxed space-y-6"
                ...
                <div className="mt-12 flex justify-between items-center border-t border-gray-200 dark:border-white/10 pt-8">
                    <Link to="/blogs" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-2">

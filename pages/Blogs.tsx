...
const Blogs: React.FC = () => {
  return (
    <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
      <div className="mb-16">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Insights & <span className="text-gradient">Innovations</span></h1>
        <p className="text-gray-400">Discover how AI is transforming the way consumers approach science and learning.</p>
      </div>
      ...
      <div className="mt-20 glass-card p-10 md:p-16 rounded-[40px] flex flex-col md:flex-row items-center justify-between gap-10">
        <div className="md:max-w-xl">
          <h2 className="text-3xl font-bold mb-4">Stay Curiously Ahead</h2>
          <p className="text-gray-400">Join 10,000+ science enthusiasts and educators who receive our weekly AI deep-dive.</p>
        </div>
        <div className="w-full md:w-96 flex flex-col space-y-3">
           <input 
              type="email" 
              placeholder="Your email address" 
              className="bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-white focus:outline-none focus:border-blue-500"
            />

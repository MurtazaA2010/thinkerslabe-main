    ...
    <div className="pt-32 pb-24 px-6 max-w-7xl mx-auto">
      ...
      <div className="space-y-12">
        {PRODUCTS.map((product) => (
          <div
            key={product.id}
            className="glass-card rounded-[32px] overflow-hidden flex flex-col md:flex-row hover:border-blue-500/50 transition-all duration-300 border border-transparent"
          >
            {/* Image */}
            ...
            <div className="p-10 md:w-3/5 flex flex-col justify-between">
              <div>
                ...
                <h4 className="text-xs font-bold text-gray-500 dark:text-gray-500 uppercase tracking-widest mb-4">
                  Core Features
                </h4>
              ...
              <div className="flex gap-4">
                ...
                <button className="px-6 py-3 bg-gray-100 hover:bg-gray-200 dark:bg-white/5 border border-gray-200 dark:border-white/10 dark:hover:bg-white/10 text-gray-900 dark:text-white font-bold rounded-xl transition-all">
